  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      <DialogPrimitive.Close
                className="absolute right-4 top-4 rounded-full bg-black/60 text-white p-1 opacity-100 hover:bg-black/70 focus:outline-none focus:ring-2 focus:ring-white">
                <X className="h-5 w-5" />
