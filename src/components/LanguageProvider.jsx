...
const i18n = {
  ...
  "agb.section6b.p2": { de: "Gewerbliche Verkäufer sind verpflichtet, den Käufern ein gesetzliches Widerrufsrecht von 14 Tagen zu gewähren und eine ordnungsgemäße Widerrufsbelehrung bereitzustellen.", it: "I Venditori commerciali sono obbligati a concedere agli acquirenti un diritto di recesso legale di 14 giorni e a fornire un'adeguata informativa sul diritto di recesso.", en: "Commercial sellers are required to grant buyers a statutory right of withdrawal of 14 days and provide proper withdrawal instructions.", fr: "Les Vendeurs commerciaux sont tenus d'accorder aux acheteurs un droit de rétractation légal de 14 jours et de fournir des instructions de rétractation appropriées.", pl: "Sprzedawcy komercyjni są zobowiązani do przyznania kupującym ustawowego prawa odstąpienia na 14 dni i dostarczenia odpowiedniej instrukcji odstąpienia.", tr: "Ticari satıcılar, alıcılara 14 günlük yasal bir cayma hakkı tanımak ve uygun cayma talimatları sağlamakla yükümlüdür.", uk: "Комерційні продавці зобов'язані надати покупцям законне право на відмову протягом 14 днів та надати належні інструкції щодо відмови." },
  "agb.section6b.p3": { de: "Zazarap übernimmt keine rechtliche Beratung oder Prüfung der vom Verkäufer bereitgestellten Widerrufsbelehrungen.", it: "Zazarap non fornisce consulenza legale né verifica le informative sul diritto di recesso fornite dal Venditore.", en: "Zazarap does not provide legal advice or verification of withdrawal instructions provided by the Seller.", fr: "Zazarap ne fournit aucun conseil juridique ni vérification des instructions de rétractation fournies par le Vendeur.", pl: "Zazarap nie świadczy porad prawnych ani weryfikacji instrukcji odstąpienia dostarczonych przez Sprzedawcę.", tr: "Zazarap, Satıcı tarafından sağlanan cayma talimatları hakkında yasal danışmanlık veya doğrulama sağlamaz.", uk: "Zazarap не надає юридичних консультацій або перевірки інструкцій щодо відмови, наданих Продавцем." },
