...
const i18n = {
  ...
  "agb.section6b.summary": { de: "Das Widerrufsrecht richtet sich ausschließlich nach der Art des Verkäufers.", it: "Il diritto di recesso dipende esclusivamente dal tipo di venditore.", en: "The right of withdrawal depends exclusively on the type of seller.", fr: "Le droit de rétractation dépend exclusivement du type de vendeur.", pl: "Prawo odstąpienia zależy wyłącznie od rodzaju sprzedawcy.", tr: "Cayma hakkı yalnızca satıcının türüne bağlıdır.", uk: "Право на відмову залежить виключно від типу продавця." },
