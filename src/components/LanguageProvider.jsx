...
const i18n = {
  ...
  "agb.section6b.p1": { de: "Die Veröffentlichung von Anzeigen auf der Plattform ist grundsätzlich kostenlos.", it: "La pubblicazione di annunci sulla Piattaforma è fondamentalmente gratuita.", en: "Publishing ads on the Platform is basically free.", fr: "La publication d'annonces sur la Plateforme est fondamentalement gratuite.", pl: "Publikacja ogłoszeń na Platformie jest zasadniczo bezpłatna.", tr: "Platform'da ilan yayınlamak temel olarak ücretsizdir.", uk: "Публікація оголошень на Платформі в основному безкоштовна." },
  "agb.section6b.p2": { de: "Der Betreiber bietet Nutzern optional kostenpflichtige Zusatzleistungen (Premium-Funktionen) an, insbesondere zur Hervorhebung, besseren Sichtbarkeit, verlängerten Laufzeit oder besonderen Kennzeichnung von Anzeigen.", it: "Il Gestore offre agli utenti servizi aggiuntivi a pagamento opzionali (funzioni premium), in particolare per l'evidenziazione, una migliore visibilità, una durata prolungata o un'etichettatura speciale degli annunci.", en: "The Operator offers users optional paid additional services (premium features), particularly for highlighting, better visibility, extended duration or special labeling of ads.", fr: "L'Exploitant offre aux utilisateurs des services supplémentaires payants optionnels (fonctions premium), en particulier pour la mise en évidence, une meilleure visibilité, une durée prolongée ou un marquage spécial des annonces.", pl: "Operator oferuje użytkownikom opcjonalne płatne usługi dodatkowe (funkcje premium), w szczególności w celu wyróżnienia, lepszej widoczności, wydłużonego czasu trwania lub specjalnego oznakowania ogłoszeń.", tr: "İşletici, kullanıcılara özellikle vurgulama, daha iyi görünürlük, uzatılmış süre veya ilanların özel etiketlenmesi için isteğe bağlı ücretli ek hizmetler (premium özellikler) sunar.", uk: "Оператор пропонує користувачам необов'язкові платні додаткові послуги (преміум-функції), зокрема для виділення, кращої видимості, подовженого терміну або спеціального маркування оголошень." },
  "agb.section6b.p3": { de: "Die Inanspruchnahme kostenpflichtiger Zusatzleistungen ist freiwillig. Die jeweiligen Kosten werden dem Nutzer vor der Buchung transparent angezeigt.", it: "L'utilizzo di servizi aggiuntivi a pagamento è volontario. I rispettivi costi vengono mostrati all'utente in modo trasparente prima della prenotazione.", en: "The use of paid additional services is voluntary. The respective costs are displayed transparently to the user before booking.", fr: "L'utilisation de services supplémentaires payants est volontaire. Les coûts respectifs sont affichés de manière transparente à l'utilisateur avant la réservation.", pl: "Korzystanie z płatnych usług dodatkowych jest dobrowolne. Odpowiednie koszty są przejrzyście wyświetlane użytkownikowi przed rezerwacją.", tr: "Ücretli ek hizmetlerin kullanımı gönüllüdür. İlgili maliyetler, rezervasyondan önce kullanıcıya şeffaf bir şekilde gösterilir.", uk: "Використання платних додаткових послуг є добровільним. Відповідні витрати прозоро відображаються користувачу перед бронюванням." },
  "agb.section6b.p4": { de: "Kostenpflichtige Zusatzleistungen stellen digitale Dienstleistungen dar und sind mit Beginn der Leistungserbringung nicht erstattungsfähig.", it: "I servizi aggiuntivi a pagamento rappresentano servizi digitali e non sono rimborsabili con l'inizio della prestazione del servizio.", en: "Paid additional services represent digital services and are non-refundable once service provision begins.", fr: "Les services supplémentaires payants représentent des services numériques et ne sont pas remboursables dès le début de la prestation de service.", pl: "Płatne usługi dodatkowe stanowią usługi cyfrowe i nie podlegają zwrotowi po rozpoczęciu świadczenia usługi.", tr: "Ücretli ek hizmetler dijital hizmetleri temsil eder ve hizmet sunumu başladığında iade edilemez.", uk: "Платні додаткові послуги є цифровими послугами і не підлягають поверненню після початку надання послуги." },
