...
const i18n = {
  ...
  "agb.section6b.p1": { de: "Bei Privatverkäufen zwischen Verbrauchern (C2C) besteht kein gesetzliches Widerrufsrecht. Eine freiwillige Rücknahme kann individuell zwischen Käufer und Verkäufer vereinbart werden.", it: "Per le vendite private tra consumatori (C2C) non esiste un diritto di recesso legale. Un ritiro volontario può essere concordato individualmente tra Acquirente e Venditore.", en: "For private sales between consumers (C2C), there is no statutory right of withdrawal. A voluntary return can be individually agreed upon between Buyer and Seller.", fr: "Pour les ventes privées entre consommateurs (C2C), il n'existe aucun droit de rétractation légal. Un retour volontaire peut être convenu individuellement entre l'Acheteur et le Vendeur.", pl: "W przypadku prywatnych sprzedaży między konsumentami (C2C) nie ma ustawowego prawa odstąpienia. Dobrowolny zwrot może być indywidualnie uzgodniony między Kupującym a Sprzedawcą.", tr: "Tüketiciler arası özel satışlarda (C2C) yasal bir cayma hakkı bulunmamaktadır. Gönüllü iade, Alıcı ve Satıcı arasında bireysel olarak kararlaştırılabilir.", uk: "Для приватних продажів між споживачами (C2C) законного права на відмову не існує. Добровільне повернення може бути індивідуально узгоджене між Покупцем та Продавцем." },
  "agb.section6b.p2": { de: "Gewerbliche Verkäufer sind gesetzlich verpflichtet, Verbrauchern ein Widerrufsrecht von 14 Tagen zu gewähren und eine ordnungsgemäße Widerrufsbelehrung bereitzustellen.", it: "I Venditori commerciali sono obbligati per legge a concedere ai consumatori un diritto di recesso di 14 giorni e a fornire un'adeguata informativa sul diritto di recesso.", en: "Commercial sellers are legally required to grant consumers a right of withdrawal of 14 days and provide proper withdrawal instructions.", fr: "Les Vendeurs commerciaux sont légalement tenus d'accorder aux consommateurs un droit de rétractation de 14 jours et de fournir des instructions de rétractation appropriées.", pl: "Sprzedawcy komercyjni są prawnie zobowiązani do przyznania konsumentom prawa odstąpienia na 14 dni i dostarczenia odpowiedniej instrukcji odstąpienia.", tr: "Ticari satıcılar, tüketicilere yasal olarak 14 günlük cayma hakkı tanımak ve uygun cayma talimatları sağlamakla yükümlüdür.", uk: "Комерційні продавці юридично зобов'язані надати споживачам право на відмову протягом 14 днів та надати належні інструкції щодо відмови." },
  "agb.section6b.p3": { de: "Der Betreiber übernimmt keine rechtliche Beratung, Prüfung oder Haftung für vom Verkäufer bereitgestellte Widerrufsbelehrungen.", it: "Il Gestore non fornisce consulenza legale, verifica o responsabilità per le informative sul diritto di recesso fornite dal Venditore.", en: "The Operator does not provide legal advice, verification or liability for withdrawal instructions provided by the Seller.", fr: "L'Exploitant ne fournit aucun conseil juridique, vérification ou responsabilité pour les instructions de rétractation fournies par le Vendeur.", pl: "Operator nie świadczy porad prawnych, weryfikacji ani nie ponosi odpowiedzialności za instrukcje odstąpienia dostarczone przez Sprzedawcę.", tr: "İşletici, Satıcı tarafından sağlanan cayma talimatları hakkında yasal danışmanlık, doğrulama veya sorumluluk sağlamaz.", uk: "Оператор не надає юридичних консультацій, перевірки або відповідальності за інструкції щодо відмови, надані Продавцем." },
