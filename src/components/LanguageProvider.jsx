...
const i18n = {
  ...
  "agb.section6.p1": { de: "(1) Die Plattform wickelt keine Zahlungen zwischen Käufer und Verkäufer ab. Etwaige Zahlungen vereinbaren die Parteien direkt. Zahlungen an den Betreiber betreffen ausschließlich Abonnements, kostenpflichtige Inserate oder Promotionen und können über externe Zahlungsdienstleister erfolgen.", it: "(1) La Piattaforma non gestisce pagamenti tra Acquirente e Venditore. Eventuali pagamenti sono concordati direttamente tra le parti. I pagamenti verso il Gestore riguardano esclusivamente abbonamenti, inserzioni a pagamento o promozioni e possono avvenire tramite fornitori di servizi di pagamento esterni.", en: "(1) The Platform does not process payments between Buyer and Seller. Any payments are agreed directly between the parties. Payments to the Operator relate exclusively to subscriptions, paid listings or promotions and may be processed via external payment service providers.", fr: "(1) La Plateforme ne traite pas les paiements entre Acheteur et Vendeur. Les paiements éventuels sont convenus directement entre les parties. Les paiements à l'Exploitant concernent exclusivement les abonnements, les annonces payantes ou les promotions et peuvent être effectués via des prestataires externes.", pl: "(1) Platforma nie obsługuje płatności między Kupującym a Sprzedającym. Ewentualne płatności są ustalane bezpośrednio między stronami. Płatności na rzecz Operatora dotyczą wyłącznie abonamentów, płatnych ogłoszeń lub promocji i mogą być realizowane za pośrednictwem zewnętrznych dostawców usług płatniczych.", tr: "(1) Platform, Alıcı ile Satıcı arasındaki ödemeleri yürütmez. Olası ödemeler taraflar arasında doğrudan kararlaştırılır. İşleticiye yapılan ödemeler yalnızca abonelikler, ücretli ilanlar veya promosyonlarla ilgilidir ve harici ödeme hizmeti sağlayıcıları üzerinden gerçekleştirilebilir.", uk: "(1) Платформа не обробляє платежі між Покупцем і Продавцем. Будь-які платежі узгоджуються безпосередньо між сторонами. Платежі на користь Оператора стосуються виключно підписок, платних оголошень або промоакцій і можуть здійснюватися через зовнішніх платіжних провайдерів." }
  ...
  "privacy.section5.li1": { de: "Zahlungsdienstleister zur Abwicklung von Plattform-Zahlungen (Abos/Promotionen)", it: "Fornitori di servizi di pagamento per pagamenti della piattaforma (abbonamenti/promozioni)", en: "Payment service providers for platform payments (subscriptions/promotions)", fr: "Prestataires de services de paiement pour les paiements de la plateforme (abonnements/promotions)", pl: "Dostawcy usług płatniczych dla płatności platformy (abonamenty/promocje)", tr: "Platform ödemeleri (abonelikler/promosyonlar) için ödeme hizmeti sağlayıcıları", uk: "Постачальники платіжних послуг для платежів платформи (підписки/промоції)" },
