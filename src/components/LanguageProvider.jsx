...
const i18n = {
  ...
  "agb.section6b.p3": { de: "Zazarap übernimmt keine rechtliche Beratung, Prüfung oder Haftung für die vom Verkäufer bereitgestellten Widerrufsbelehrungen.", it: "Zazarap non fornisce consulenza legale, verifica o responsabilità per le informative sul diritto di recesso fornite dal Venditore.", en: "Zazarap does not provide legal advice, verification or liability for withdrawal instructions provided by the Seller.", fr: "Zazarap ne fournit aucun conseil juridique, vérification ou responsabilité pour les instructions de rétractation fournies par le Vendeur.", pl: "Zazarap nie świadczy porad prawnych, weryfikacji ani nie ponosi odpowiedzialności za instrukcje odstąpienia dostarczone przez Sprzedawcę.", tr: "Zazarap, Satıcı tarafından sağlanan cayma talimatları hakkında yasal danışmanlık, doğrulama veya sorumluluk sağlamaz.", uk: "Zazarap не надає юридичних консультацій, перевірки або відповідальності за інструкції щодо відмови, надані Продавцем." },
  ...
  "agb.section10.li12": { de: "Gewerbliche Angebote ohne ordnungsgemäße Kennzeichnung als gewerblicher Verkäufer", it: "Offerte commerciali senza corretta identificazione come venditore commerciale", en: "Commercial offers without proper identification as a commercial seller", fr: "Offres commerciales sans identification appropriée en tant que vendeur commercial", pl: "Oferty komercyjne bez odpowiedniej identyfikacji jako sprzedawca komercyjny", tr: "Ticari satıcı olarak uygun tanımlama olmaksızın ticari teklifler", uk: "Комерційні пропозиції без належної ідентифікації як комерційного продавця" },
  ...
  "agb.section11a.p1": { de: "Zur Aufrechterhaltung der Sicherheit und Einhaltung dieser AGB setzt Zazarap automatisierte Systeme, einschließlich KI-gestützter Filter, ein.", it: "Per mantenere la sicurezza e il rispetto delle presenti CGC, Zazarap utilizza sistemi automatizzati, inclusi filtri supportati da IA.", en: "To maintain security and compliance with these GTC, Zazarap uses automated systems, including AI-supported filters.", fr: "Pour maintenir la sécurité et le respect des présentes CG, Zazarap utilise des systèmes automatisés, y compris des filtres assistés par IA.", pl: "W celu utrzymania bezpieczeństwa i przestrzegania niniejszych OW, Zazarap wykorzystuje zautomatyzowane systemy, w tym filtry wspierane przez AI.", tr: "Bu GŞK'nın güvenliğini ve uyumunu sürdürmek için Zazarap, AI destekli filtreler de dahil olmak üzere otomatik sistemler kullanır.", uk: "Для підтримки безпеки та дотримання цих ЗУ, Zazarap використовує автоматизовані системи, включаючи фільтри на основі AI." },
  "agb.section11a.p2": { de: "Diese Systeme können Inhalte, Angebote oder Nutzerkonten automatisch einschränken, deaktivieren oder entfernen.", it: "Questi sistemi possono limitare, disattivare o rimuovere automaticamente contenuti, offerte o account utente.", en: "These systems may automatically restrict, deactivate or remove content, offers or user accounts.", fr: "Ces systèmes peuvent automatiquement restreindre, désactiver ou supprimer du contenu, des offres ou des comptes utilisateur.", pl: "Te systemy mogą automatycznie ograniczać, dezaktywować lub usuwać treści, oferty lub konta użytkowników.", tr: "Bu sistemler, içeriği, teklifleri veya kullanıcı hesaplarını otomatik olarak kısıtlayabilir, devre dışı bırakabilir veya kaldırabilir.", uk: "Ці системи можуть автоматично обмежувати, деактивувати або видаляти контент, пропозиції або облікові записи користувачів." },
  "agb.section11a.p3": { de: "Ein Anspruch auf Veröffentlichung bestimmter Inhalte besteht nicht. Fehlentscheidungen können im Rahmen eines Prüfverfahrens gemeldet werden.", it: "Non esiste alcun diritto alla pubblicazione di contenuti specifici. Le decisioni errate possono essere segnalate nell'ambito di una procedura di revisione.", en: "There is no entitlement to publication of specific content. Erroneous decisions can be reported as part of a review process.", fr: "Il n'existe aucun droit à la publication de contenus spécifiques. Les décisions erronées peuvent être signalées dans le cadre d'une procédure de révision.", pl: "Nie ma prawa do publikacji określonych treści. Błędne decyzje mogą być zgłaszane w ramach procedury przeglądu.", tr: "Belirli içeriklerin yayınlanması konusunda bir hak yoktur. Hatalı kararlar bir inceleme süreci kapsamında bildirilebilir.", uk: "Немає права на публікацію конкретного контенту. Помилкові рішення можуть бути повідомлені в рамках процедури перевірки." },
