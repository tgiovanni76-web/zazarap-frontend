...
const i18n = {
  ...
  "agb.section6b.p1": { de: "Der Betreiber erhebt für die Veröffentlichung von Anzeigen auf der Plattform ein Entgelt.", it: "Il Gestore addebita un compenso per la pubblicazione di annunci sulla Piattaforma.", en: "The Operator charges a fee for publishing ads on the Platform.", fr: "L'Exploitant facture des frais pour la publication d'annonces sur la Plateforme.", pl: "Operator pobiera opłatę za publikację ogłoszeń na Platformie.", tr: "İşletici, Platform'da ilan yayınlamak için ücret alır.", uk: "Оператор стягує плату за публікацію оголошень на Платформі." },
  "agb.section6b.p2": { de: "Das Entgelt stellt eine Vergütung für die Bereitstellung, Darstellung und Sichtbarkeit der Anzeige dar und ist unabhängig vom Abschluss eines Kaufvertrags zwischen Käufer und Verkäufer.", it: "Il compenso rappresenta una remunerazione per la messa a disposizione, la presentazione e la visibilità dell'annuncio ed è indipendente dalla conclusione di un contratto di vendita tra Acquirente e Venditore.", en: "The fee represents compensation for the provision, display and visibility of the ad and is independent of the conclusion of a purchase contract between Buyer and Seller.", fr: "Les frais représentent une compensation pour la mise à disposition, l'affichage et la visibilité de l'annonce et sont indépendants de la conclusion d'un contrat de vente entre l'Acheteur et le Vendeur.", pl: "Opłata stanowi wynagrodzenie za udostępnienie, wyświetlenie i widoczność ogłoszenia i jest niezależna od zawarcia umowy kupna między Kupującym a Sprzedawcą.", tr: "Ücret, ilanın sağlanması, görüntülenmesi ve görünürlüğü için bir tazminat temsil eder ve Alıcı ile Satıcı arasında bir satış sözleşmesinin yapılmasından bağımsızdır.", uk: "Плата є компенсацією за надання, відображення та видимість оголошення і не залежить від укладення договору купівлі-продажу між Покупцем та Продавцем." },
  "agb.section6b.p3": { de: "Die Höhe des Entgelts wird dem Verkäufer vor Veröffentlichung der Anzeige transparent angezeigt.", it: "L'importo del compenso viene mostrato al Venditore in modo trasparente prima della pubblicazione dell'annuncio.", en: "The amount of the fee is displayed transparently to the Seller before the ad is published.", fr: "Le montant des frais est affiché de manière transparente au Vendeur avant la publication de l'annonce.", pl: "Wysokość opłaty jest przejrzyście wyświetlana Sprzedawcy przed publikacją ogłoszenia.", tr: "Ücret tutarı, ilan yayınlanmadan önce Satıcıya şeffaf bir şekilde gösterilir.", uk: "Розмір плати прозоро відображається Продавцю перед публікацією оголошення." },
  "agb.section6b.p4": { de: "Das Entgelt für die Anzeigenveröffentlichung ist nicht erstattungsfähig, auch wenn die Anzeige keinen Verkaufserfolg erzielt oder der Kaufvertrag später widerrufen oder nicht abgeschlossen wird.", it: "Il compenso per la pubblicazione dell'annuncio non è rimborsabile, anche se l'annuncio non ottiene successo di vendita o il contratto di vendita viene successivamente revocato o non concluso.", en: "The fee for ad publication is non-refundable, even if the ad does not achieve sales success or the purchase contract is later withdrawn or not concluded.", fr: "Les frais de publication de l'annonce ne sont pas remboursables, même si l'annonce n'obtient pas de succès commercial ou si le contrat de vente est ultérieurement annulé ou non conclu.", pl: "Opłata za publikację ogłoszenia nie podlega zwrotowi, nawet jeśli ogłoszenie nie osiągnie sukcesu sprzedażowego lub umowa kupna zostanie później wycofana lub nie zostanie zawarta.", tr: "İlan yayınlama ücreti, ilan satış başarısı elde etmese veya satış sözleşmesi daha sonra geri çekilse veya yapılmasa bile iade edilemez.", uk: "Плата за публікацію оголошення не підлягає поверненню, навіть якщо оголошення не досягне успіху в продажах або договір купівлі-продажу буде пізніше відкликано або не укладено." },
