  ...
  return (
    <ErrorBoundary>
      ...
      <style>{`
        ...
        `}</style>
      <header className="bg-[var(--z-primary)] px-5 py-2.5 border-b-[3px] border-[var(--z-accent)] rounded-b-xl sticky top-0 z-50 max-w-full overflow-x-hidden overflow-y-visible shadow-none">
